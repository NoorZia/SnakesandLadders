...
public class Level1Adapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if((position+1)%13 == 0 ){
            ...
            tv.setBackgroundResource(R.drawable.snake);   //Set position of snakes

        }
        else  if((position+1)%17 == 0){

            tv.setBackgroundResource(R.drawable.ladder);   //set position of ladder
