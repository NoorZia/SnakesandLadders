...
public class Level1 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final Level1Adapter im = new Level1Adapter(this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(turn1==1){
                    ...
                    int i1 = r.nextInt(6) + 1;   //get new random number

                    new_position1 = currentposition1 + i1;
                    Toast.makeText(Level1.this, "Move to position " + new_position1,
                ...
                {
                    Toast.makeText(Level1.this, "Its not your turn",
                            Toast.LENGTH_SHORT).show();
                }
            }
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                if (turn1 == 1) {
                    ...
                    if(new_position1<=100) {   //move user to new position if less than 100
                        if (position + 1 != new_position1) {
                            Toast.makeText(Level1.this, "Wrong move, Move to " + new_position1,
                                    Toast.LENGTH_SHORT).show();
                            ...
                            if ((clicked_position1 + 1) % 13 == 0) {
                                ...
                                Toast.makeText(Level1.this, "Moving up",
                                        Toast.LENGTH_SHORT).show();

                            }
                            if ((clicked_position1 + 1) % 17 == 0) {
                                clicked_position1 += 11;
                                Toast.makeText(Level1.this, "Moving down",
                                        Toast.LENGTH_SHORT).show();
                            }
                            position = old_color1;
                        ...
                        if(new_position1==100){    //declare user winner if position is 100
                        ...
                        Toast.makeText(Level1.this, "You cannot make this move",
                                Toast.LENGTH_SHORT).show();
                ...
                if(turn2==1) {
                    Toast.makeText(Level1.this, "Computers Turn",
                            Toast.LENGTH_SHORT).show();
                    turn2 = 0;
                    turn1 = 1;
                    ...
                    if (new_position2 <= 99) {
                        Toast.makeText(Level1.this, "Moving to " + Integer.toString(new_position2+1),
                                Toast.LENGTH_SHORT).show();

                        if ((new_position2 + 1) % 13 == 0) {
                            new_position2 -= 11;
                            Toast.makeText(Level1.this, "Moving up",
                                    Toast.LENGTH_SHORT).show();
                        }
                        ...
                        Toast.makeText(Level1.this, "Computer cannot make this move",
                                Toast.LENGTH_SHORT).show();
