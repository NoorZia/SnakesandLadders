...
public class Level2 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final Level2Adapter im = new Level2Adapter(this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(turn1==1){
                    ...
                    Toast.makeText(Level2.this, "Move to position " + new_position1,
                ...
                {
                    Toast.makeText(Level2.this, "Its not your turn",
                            Toast.LENGTH_SHORT).show();
                }
            }
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                if (turn1 == 1) {
                    ...
                    if(new_position1<=100) {
                        if (position + 1 != new_position1) {
                            Toast.makeText(Level2.this, "Wrong move, Move to " + new_position1,
                                    Toast.LENGTH_SHORT).show();
                            ...
                            if ((clicked_position1 + 1) % 13 == 0) {
                                ...
                                Toast.makeText(Level2.this, "Moving up",
                                        Toast.LENGTH_SHORT).show();

                            }
                            if ((clicked_position1 + 1) % 17 == 0) {
                                clicked_position1 -= 11;
                                Toast.makeText(Level2.this, "Moving down",
                                        Toast.LENGTH_SHORT).show();
                            }
                            position = old_color1;
                        ...
                        Toast.makeText(Level2.this, "You cannot make this move",
                                Toast.LENGTH_SHORT).show();
                ...
                if(turn2==1) {
                    Toast.makeText(Level2.this, "Computers Turn",
                            Toast.LENGTH_SHORT).show();
                    turn2 = 0;
                    turn1 = 1;
                    ...
                    if (new_position2 <= 99) {
                        Toast.makeText(Level2.this, "Moving to " + new_position2,
                                Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(Level2.this, "Computer cannot make this move",
                                Toast.LENGTH_SHORT).show();
